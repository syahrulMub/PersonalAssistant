...
namespace AIPersonalAssistant.Migrations
{
    ...
    [Migration("20260914153741_AIMemoryForTrainingBehavior")]
    partial class AIMemoryForTrainingBehavior
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AIPersonalAssistant.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            PasswordHash = "$2a$11$mbkLOWYiFFMI8OOTLr7KQO4QkxDM9kZp1RizBUI6dlGWSk3ty/nwK",
                            Role = "Admin"
                        });
                });
