        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositiveAffirmations = table.Column<string>(type: "TEXT", nullable: false),
                    ActionableInsights = table.Column<string>(type: "TEXT", nullable: false),
                    EmailSendAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsEmailSent = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIRecaps", x => x.Id);
                });
        }
