...
namespace AIPersonalAssistant.Migrations
{
    ...
    [Migration("20260922190626_TracebackMemoryAI")]
    partial class TracebackMemoryAI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIPersonalAssistant.Models.AIDailySummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("BriefingDate")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AIPersonalAssistant.Models.ActivityLogs", b =>
                {
                    ...
                    b.Property<DateTime?>("MemorySyncedAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AIPersonalAssistant.Models.TracebackMemory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AIPersonalAssistant.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            PasswordHash = "$2a$11$pKiNpE/oRPsspWUsx2lbmemRKZ7l5QfagHQA7jg0DANPkSHbXeg06",
                            Role = "Admin"
                        });
                });
